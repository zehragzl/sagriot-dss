    ...
    "tomato": {
        ...
        "stages": {
            "default": {
                ...
                # soil_fc has no upper limit: no rule acts on over-watering, and the
                # rule review found no source for a high-side threshold. See plants.py notes.
                "soil_fc":        {"crit_low": 60,   "warn_low": 70,  "warn_high": None, "crit_high": None},
    ...
    "cucumber": {
        ...
        "stages": {
            "default": {
                ...
                "soil_fc":        {"crit_low": 65,   "warn_low": 70,   "warn_high": None, "crit_high": None},
    ...
    "strawberry": {
        ...
        "stages": {
            "default": {
                ...
                "soil_fc":        {"crit_low": 65,   "warn_low": 75,  "warn_high": None, "crit_high": None},
